...
if ($_REQUEST['Editdemand']) {
    ...
    $db = getDb();
    $stmt = $db->prepare(
        'SELECT id, material, quantitykg, areacodeid, pickupdatetime FROM ondemand_binpickup WHERE id=(:id)'
    );
...
if (isset($_POST['submit'])) {
    ...
    $sql =
        'UPDATE ondemand_binpickup SET pickupdatetime=(:PickupDateTime), material=(:maTerial), quantitykg=(:quantityKG), areacodeid=(:Areacode) WHERE id=(:id)';
    $db = getDb();
    $query = $db->prepare($sql);
...
<div class="right_col" role="main">
        ...
        <div class="row">
                  ...
                  <!-- <div class="item form-group">
                          ...
                          <select class="browser-default custom-select" name="citizenid" >
                            <?php
                            $db = getDb();
                  ...
                  ?>
                     ...
                     <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                        <input type="" autocomplete="off" name="pickupdatetime" class="form-control " value="<?php echo $client->pickupdatetime; ?>">  
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="material" autocomplete="off" required="required" class="form-control " value="<?php echo $client->material; ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="quantitykg" autocomplete="off" required="required" class="form-control" placeholder="Quantity in Kg" value="<?php echo $client->quantitykg; ?>">
											</div>
										</div>
                    <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                      <select class="browser-default custom-select" name="areacode" >
                            <?php
                            $db = getDb();
                            $stmt = $db->prepare('SELECT * FROM areacodes');
                            $stmt->execute();
                            ...
                            foreach ($areas as $area) { ?>
                              ...
                              <option value="<?php echo $area->areacode; ?>"><?php echo $area->areacode; ?></option>                                             
                           <?php }
                            ?>
                          </select>
											</div>
